...
- **Link to your GitHub repository**: https://github.com/kbrow275/biostat777-intro-Kate-Brown.git

- **Link to your deployed website**: https://kbrow275.quarto.pub/project1_website/
...
```{bash}
awk -F, '{sum += $5} END {print "Average grade:", sum / NR}' students.csv
